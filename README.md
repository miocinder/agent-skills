...
Codex를 주 실행 환경으로 사용하는 개인용 에이전트 스킬 모음입니다. 여러 프로젝트에서 반복되는 작업 절차와 안전 기준을 한국어 사용자 문서와 함께 관리합니다.

특정 팀이나 제품을 위한 공식 스킬 컬렉션은 아닙니다.

## 포함된 스킬

| 스킬 | 용도 |
| --- | --- |
| [agents-md-guide](./skills/agents-md-guide/README.md) | 저장소의 `AGENTS.md`를 작성·검토하고 지속적으로 유지할 프로젝트 규칙을 식별합니다. |
...
- 이 저장소의 스킬은 특정 제품, 서비스, 팀 또는 코드베이스에 종속되지 않는 공통 작업 규칙입니다.
- 실제 작업에서는 해당 프로젝트의 `AGENTS.md`, `DESIGN.md`, README, 개발 문서와 사용자의 명시적 요구사항을 우선합니다.
- 프로젝트별로 재사용할 규칙은 공통 스킬에 추가하지 않고 해당 프로젝트의 지침으로 관리합니다.
