...
- Replace vague copy with product-true, user-oriented language. Never invent statistics, customer quotes, pricing, integrations, certifications, or guarantees.
...
- Reduce visual noise: remove decoration that does not orient, explain, or support the task.
